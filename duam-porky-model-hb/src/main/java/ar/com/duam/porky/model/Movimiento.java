...
public class Movimiento implements Serializable, Comparable<Movimiento>
{
    ...
    {
    	return getImporte() * getConcepto().getTipoConcepto().getFactor();
    }
    ...
    public void updateImporteFromConcepto()
    {
    	if (this.importe == null || this.importe == 0)
    	{
    		this.importe = this.concepto.getValorPorDefecto();
    	}
    }
